...
export const ReactDocsTopBarSection = () => {
  ...
  return (
    <DocsContentPage>
      ...
      <p id="basic-usage">
        Predefined section component to match the designs, e.g centers the content vertically. Check the full usage on <Link to="/docs/react/building-top-bar">Building Top Bar</Link>
      </p>
