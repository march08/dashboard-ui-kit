...
export const ReactDocsIcon = () => {
  ...
  return (
    <DocsContentPage>
      ...
      <p>This is a set of icons specific to the @duik. The icon set is not part of the <code>@duik/it</code> and has to be imported separatedly to dramatically reduce overall size of the library.</p>
      <p>Icons are coming from a set of fonts, leveraging typographic ligature. Change the color the same way you would do as with a font.</p>
      ...
      <ExampleTable fixed data={[
        ...
        { content: <Button square><Icon>building</Icon></Button> },
        { content: <Button><Icon mr>building</Icon>Text</Button> },
        { content: <Button>Text<Icon ml>building</Icon></Button> },
      ]} />
