  ...
  return (
    <DocsContentPage>
      ...
      <ExampleTable data={[
        ...
        {
          content: (<TextArea label="Label" rows={10} defaultValue="Passing other attrs to textarea" />)
        },
        {
          content: (<TextArea label="Label" errorMessage="There is a problem" placeholder="Write Something" />)
        },
        {
          content: (<TextArea label="Label" successMessage="It's ok!" placeholder="Write Something" />)
        },
        {
          content: (<TextArea readOnly label="Read Only" placeholder="Write Something" />)
        },
        {
          content: (<TextArea disabled label="Disabled" defaultValue="Disabled content" />)
        },
        {
          content: (<TextArea clear placeholder="Clear with no border or background" />)
        },
      ]} />
      <PropTable />
