    ...
    <DocsContentPage >
      ...
      <div style={{ color: 'white' }}>
        ...
        <div style={{ height: '300px', display: 'flex' }}>
          <div style={{ background: '#ff5252', flexBasis: '30%', height: '300px' }}>
            Menu
            </div>
          <div style={{ background: '#ffb142', flexBasis: '70%', height: '300px' }}>
            Main Content
            </div>
        </div>
      </div>
      <h3 id="vertical-split">Step 1: splitting the layout verticaly - top bar and the content</h3>
      <p>We know that we will always have these 3 segments visible. Let's cut the layout down into two parts. The top bar and the rest first, like this:</p>
      <br />
    ...
    <ContainerVertical>
      ...
      <div style={{ color: 'white' }}>
        ...
        <div style={{ height: '300px', display: 'flex' }}>
          ...
          <div style={{ padding: '15px', border: '1px solid #ddd', flexBasis: '30%' }}>
            <div style={{ background: '#ff5252', height: '270px' }}>
              Menu
              </div>
          </div>
          <div style={{ padding: '15px', flexBasis: '70%', border: '1px solid #ddd' }}>
...
const MyLayout = () => (
  <div style={ { height: '400px' } }> {/* just to simulate viewport*/}
    <ContainerVertical>
      ...
      <h2 id="full-example">Full Example: Using duik components in the layout</h2>
      <p>If you generally like the layout of the UI Kit, you can also use the predefined components to build the layout quickly. Here is an simple example, in which we will be using:</p>
      <ul>
        <li>
          <Link to="/docs/react/container-horizontal">ContainerHorizontal</Link>
        </li>
