...
const optionsUsers = [
  { label: <Avatar sm imgUrl={assets.a01} name="Johny Gaudreau" />, value: 1, name: "Johny Gaudreau" },
  { label: <Avatar sm imgUrl={assets.a02} name="Vilma Novak" />, value: 2, name: "Vilma Novak" },
  { label: <Avatar sm imgUrl={assets.a03} name="Alice Queen" />, value: 3, name: "Alice Queen" },
  { label: <Avatar sm imgUrl={assets.a04} name="Evgeny Kuznetsov" />, value: 4, name: "Evgeny Kuznetsov" },
  { label: <Avatar sm imgUrl={assets.a05} name="Jana Johnsson" />, value: 5, name: "Jana Johnsson" },
  { label: <Avatar sm imgUrl={assets.a06} name="Karolina Kolarova" />, value: 6, name: "Karolina Kolarova" },
  { label: <Avatar sm imgUrl={assets.a07} name="Klara Horton" />, value: 7, name: "Klara Horton" },
  { label: <Avatar sm imgUrl={assets.a08} name="Luu Thanh Nga" />, value: 8, name: "Luu Thanh Nga" },
]
