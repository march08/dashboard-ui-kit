...
export const ReactDocsTopBarLink = (props: RouteComponentProps) => {
  ...
  return (
    <DocsContentPage>
      ...
      <p id="basic-usage">
        Prestyled navigation for top bar. Check the full usage on <Link to="/docs/react/building-top-bar">Building Top Bar</Link>. For the best usage, wrap your TopBarTitle with <Link to="/docs/react/top-bar-link-container">TopBarLinkContainer</Link>.
      </p>
