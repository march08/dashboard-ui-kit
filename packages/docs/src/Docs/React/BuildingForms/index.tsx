  ...
  <form>
    <FormGroupContainer>
      ...
      <FormGroupContainer horizontal>
        ...
        <FormGroup>
          <Select block placeholder="Select State" label="State" options={[{ value: 1, label: 'Option' }]} />
        </FormGroup>
      </FormGroupContainer>
      <FormGroup>
        <TextArea label="Bio" />
...
const searchExample = (
  <>
    <TopBar>
      <TopBarSection>
        <TopBarSection>
          <TopBarTitle><Icon className="c-primary">front_store</Icon>Dashboard</TopBarTitle>
          <TopBarSection>
          </TopBarSection>
          <TopBarLinkContainer>
            <TopBarLink href="#">Link 1</TopBarLink>
            <TopBarLink className="active" href="#">Link 2</TopBarLink>
          </TopBarLinkContainer>
        </TopBarSection>
      </TopBarSection>
      <TopBarSection>
        <TextField placeholder="Search for lemonades" rightEl={<Icon>search_left</Icon>} />
      </TopBarSection>
    </TopBar>
    <section style={{ textAlign: 'center', padding: 50, background: 'var(--bg-base)' }}>
      Some content
    </section>
  </>
);
...
export const ReactDocsBuildingTopBar = () => {
  ...
  return (
    <DocsContentPage>
      ...
      <p>
        This page offers some specific examples of how to build your perfect TopBar. Make sure you visit <Link to="/docs/react/building-layout">Building Layout</Link> page as well!
      </p>
      <h2>List of related components</h2>
      <ol>
        <li><Link to="/docs/react/top-bar">TopBar</Link></li>
        <li><Link to="/docs/react/top-bar-link">TopBarLink</Link></li>
        <li><Link to="/docs/react/top-bar-link-container">TopBarLinkContainer</Link></li>
        <li><Link to="/docs/react/top-bar-section">TopBarSection</Link></li>
        <li><Link to="/docs/react/top-bar-title">TopBarTitle</Link></li>
      </ol>
