...
export const ReactDocsTopBarTitle = () => {
  ...
  return (
    <DocsContentPage>
      ...
      <p id="basic-usage">
        Prestyled title for top bar. Check the full usage on <Link to="/docs/react/building-top-bar">Building Top Bar</Link>. For the best usage, wrap your TopBarTitle with <Link to="/docs/react/top-bar-section">TopBarSection</Link>.
      </p>
