...
`}
      ...
      <p>Let's render a simple button. By importing <code>@duik/it</code>, we are including the whole package in our build.</p>
      <Code>
...
const MyApp = () => {
  return (
    <Button primary>My First DUIK Button</Button>
      ...
      <p>You can also import only components you need to reduce the build size.</p>
      <Code>
