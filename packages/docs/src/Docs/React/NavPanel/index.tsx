...
export const ReactDocsNavPanel = () => {
  ...
  return (
    <DocsContentPage>
      ...
      <p>By default, border is rendered on the right side of the container. If you are placing nav panel on the left side, add "onRight" property to render the border on the left.</p>
      <ExampleTable data={[
        {
          content: (
            <NavPanel onRight>
